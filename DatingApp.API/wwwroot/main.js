...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        this.alertify.error('Invalid Attept!');
...
var MemberDetailResolver = /** @class */ (function () {
    ...
    MemberDetailResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
...
/*!************************************************!*\
  !*** ./src/app/_resolver/messages.resolver.ts ***!
  \************************************************/
/*! exports provided: MeessagesResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeessagesResolver", function() { return MeessagesResolver; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_services/user.service */ "./src/app/_services/user.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
...
var MeessagesResolver = /** @class */ (function () {
    function MeessagesResolver(userService, authService, router, alertify) {
        this.userService = userService;
        this.authService = authService;
        this.router = router;
        this.alertify = alertify;
    ...
    MeessagesResolver.prototype.resolve = function (route) {
        var _this = this;
    ...
    MeessagesResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MeessagesResolver);
    return MeessagesResolver;
}());
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function (page, itemsPerPage, userParams, likesParams) {
        ...
        return this.http.get(this.baseUrl + 'users', { observe: 'response', params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
    ...
    UserService.prototype.sendLike = function (id, reciepientId) {
    ...
    UserService.prototype.sendMessage = function (id, message) {
        ...
        var mss = this.http.post(this.baseUrl + 'users/' + id + '/messages/', message);
        // console.log(mss);
        return mss;
    };
...
/* harmony import */ var _members_member_detiail_member_detiail_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./members/member-detiail/member-detiail.component */ "./src/app/members/member-detiail/member-detiail.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _members_member_detiail_member_detiail_component__WEBPACK_IMPORTED_MODULE_24__["MemberDetiailComponent"],
            ...
            providers: [
                ...
                _resolver_lists_resolver__WEBPACK_IMPORTED_MODULE_31__["ListResolver"],
                _resolver_messages_resolver__WEBPACK_IMPORTED_MODULE_32__["MeessagesResolver"]
            ],
...
module.exports = "div.container.home{\r\n    margin-top:10% !important;\r\n}"
...
module.exports = "<div class=\"container mt-5 home\">\n  <div *ngIf=\"!registerMode\" class=\"text-center\">\n    <h1><strong>Find your match</strong></h1>\n    <p class=\"lead\">Come on in to view your matches... Just sign up and get start!</p>\n    <div class=\"text-center\">\n      <button class=\"btn btn-dark btn-lg m-1\" (click)=\"registerToggle()\">Register</button>\n      <button class=\"btn btn-info btn-lg m-1\">Learn more</button>\n    </div>\n  </div>\n  <div *ngIf=\"registerMode\" class=\"container\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-5\">\n        <!-- <app-register [valuesFromHome]=\"values\" (cancelRegister)=\"cancelRegisterMode($event)\"></app-register> -->\n        <app-register (cancelRegister)=\"cancelRegisterMode($event)\"></app-register>\n      </div>\n    </div>\n  </div>\n</div>\n\n<!-- <p *ngFor=\"let value of values\">{{value.name}}</p> -->"
...
/***/ "./src/app/members/member-detiail/member-detiail.component.css":
/*!*********************************************************************!*\
  !*** ./src/app/members/member-detiail/member-detiail.component.css ***!
  \*********************************************************************/
/*! no static exports found */
...
module.exports = ".col-sm-8{\r\n    /* background-color: #fff !important; */\r\n}\r\n\r\n.img-thumbnail{\r\n    width:100%;\r\n    height:85%;\r\n}\r\n\r\n.card-body{\r\n    padding: 20px 25px 0px 25px;\r\n}\r\n\r\n.card-footer{\r\n    padding: 10px 25px 15px 25px;\r\n    background-color: #fff;\r\n    border-top:none;\r\n}\r\n\r\n.col-sm-4 .card{\r\n    border: 1px solid #f3f3f3;\r\n}\r\n\r\n.col-sm-4 .img-thumbnail{\r\n    border:0px;\r\n}\r\n\r\n.tab-panel {\r\n    border: 1px solid #f3f3f3;\r\n}\r\n\r\n.profile-title h1 strong {\r\n    color: #772953;\r\n}"

/***/ }),

/***/ "./src/app/members/member-detiail/member-detiail.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/members/member-detiail/member-detiail.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\">\n  <div class=\"mt-5 mb-4 border-bottom profile-title\">\n    <h1><strong>{{user.knownAs}}'s Profile</strong></h1>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-sm-4\">\n      <div class=\"card\">\n        <img src=\"{{user.photoUrl || '../../../assets/user.png'}}\" alt=\"{{user.knownAs}}\" \n        class=\"card-img-top img-thumbnail\">\n        <div class=\"card-body\">\n          <div>\n            <strong>Location</strong>\n            <p class=\"text-muted\">{{user.city}}, {{user.country}}</p>\n          </div>\n          <div>\n            <strong>Age</strong>\n            <p class=\"text-muted\">{{user.age}}</p>\n          </div>\n          <div>\n            <strong>Last Active</strong>\n            <p class=\"text-muted\">{{user.lastActive | timeAgo}}</p>\n          </div>\n          <div>\n            <strong>Joined since</strong>\n            <p class=\"text-muted\">{{user.created | date: 'mediumDate'}}</p>\n          </div>\n        </div>\n        <div class=\"card-footer\">\n          <div class=\"btn-group d-flex\">\n            <button class=\"btn btn-primary w-100\"><i class=\"fa fa-heart\"></i> Like</button>\n            <button class=\"btn btn-success w-100\" (click)=\"selectTab(3)\"><i class=\"fa fa-envelope\"></i> Messages</button>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col-sm-8\">\n      <div class=\"tab-panel\">\n        <tabset class=\"member-tabset\" #memberTabs>\n          <tab class=\"mt-3\" heading=\"About {{user?.knownAs}}\">\n            <h4>Description</h4>\n            <p class=\"text-muted\">{{user.introduction}}</p>\n            <h4>Looking for</h4>\n            <p class=\"text-muted\">{{user.lookingFor}}</p>\n          </tab>\n          <tab class=\"mt-3\" heading=\"Interests\">\n            <h4>Interests</h4>\n            <p>{{user.interests}}</p>\n          </tab>          \n          <tab heading=\"Photos\">\n            <div class=\"d-flex justify-content-center align-items-center mt-5\">\n            <ngx-gallery [options]=\"galleryOptions\" [images]=\"galleryImages\"></ngx-gallery>\n            </div>\n          </tab>  \n          <tab heading=\"Messages\">\n            <app-member-messages [recipientId]=\"user.id\"></app-member-messages>\n          </tab>\n        </tabset>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/members/member-detiail/member-detiail.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/members/member-detiail/member-detiail.component.ts ***!
  \********************************************************************/
/*! exports provided: MemberDetiailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MemberDetiailComponent", function() { return MemberDetiailComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MemberDetiailComponent = /** @class */ (function () {
    function MemberDetiailComponent(userService, alertify, route) {
        this.userService = userService;
        this.alertify = alertify;
        this.route = route;
    }
    MemberDetiailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.data.subscribe(function (data) {
    ...
    MemberDetiailComponent.prototype.getImages = function () {
        var imageUrls = [];
    ...
    MemberDetiailComponent.prototype.selectTab = function (tabId) {
    ...
    ], MemberDetiailComponent.prototype, "memberTabs", void 0);
    MemberDetiailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-member-detiail',
            template: __webpack_require__(/*! ./member-detiail.component.html */ "./src/app/members/member-detiail/member-detiail.component.html"),
            styles: [__webpack_require__(/*! ./member-detiail.component.css */ "./src/app/members/member-detiail/member-detiail.component.css")]
        }),
...
var MemberMessagesComponent = /** @class */ (function () {
    function MemberMessagesComponent(userServices, alertify, authService) {
        ...
        this.userServices.getMessageThread(this.authService.decodedToken.nameid, this.recipientId)
            ...
            for (var i = 0; i < messages.length; i++) {
                if (messages[i].isRead === false && messages[i].recipientId === currentUserId) {
                    _this.userServices.markAsRead(currentUserId, messages[i].id);
                }
            }
        }))
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.alertify.confirm('Do you really want to continue with this action?', function () {
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        this.alertify.confirm('Sure you want to continue?', function () {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        var _this = this;
        // if the register form is in a valid state
        if (this.registerForm.valid) {
            // assign the values in the form to the user object
            this.user = Object.assign({}, this.registerForm.value);
            // register the user
            // run through the following pipeline on the authService.register method
            // 1. on successful registration, display success message
            // 2. on error, display error message
            // 3. then log the user in and
            // 4. navigate the user to members page
...
/* harmony import */ var _members_member_detiail_member_detiail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./members/member-detiail/member-detiail.component */ "./src/app/members/member-detiail/member-detiail.component.ts");
...
var appRoutes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'members/:id', component: _members_member_detiail_member_detiail_component__WEBPACK_IMPORTED_MODULE_5__["MemberDetiailComponent"],
            ...
            { path: 'messages', component: _messages_messages_component__WEBPACK_IMPORTED_MODULE_2__["MessagesComponent"], resolve: { messages: _resolver_messages_resolver__WEBPACK_IMPORTED_MODULE_12__["MeessagesResolver"] } },
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_3__["ListsComponent"], resolve: { users: _resolver_lists_resolver__WEBPACK_IMPORTED_MODULE_11__["ListResolver"] } },
        ]
    },
...
module.exports = __webpack_require__(/*! C:\Users\cidos\Source\My Practice\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
